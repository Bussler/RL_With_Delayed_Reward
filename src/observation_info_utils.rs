...
impl Observation {
    ...
    pub fn to_py_dict(&self, py: Python) -> PyResult<Py<PyDict>> {
        ...
        let player_pos = (self.player_position.x, self.player_position.y, self.player_position.z);
        ...
        let target_positions: Vec<(f64, f64, f64)> = self.target_positions
            .iter()
        ...
        let target_velocities: Vec<(f64, f64, f64)> = self.target_velocities
            .iter()
